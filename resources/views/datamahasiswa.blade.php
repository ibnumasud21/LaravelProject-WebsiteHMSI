...
<div class="table-mahasiswa">
      ...
      <form action="/data/mahasiswa/cari" method="GET" class="form-inline">
      ...
      <table class ="table table-striped" border="1" >
        ...
        <tr>
          ...
          <td>{{ $p->id_angkatan }}</td>
          <td>
            <a class="btn btn-warning btn-sm" href="/data/mahasiswa/edit/{{ $p->nim }}">Edit</a>
            |
            <a class="btn btn-danger btn-sm" href="/data/mahasiswa/hapus/{{ $p->nim }}">Hapus</a>
          </td>
          </tr>
        @endforeach
      ...
      <br/>
      <br/>
      <a class="btn btn-primary" href="/data/mahasiswa/tambah"> + Data Mahasiswa Baru</a>
      <br/>
      <br/>
      <br/>
      <br/>
